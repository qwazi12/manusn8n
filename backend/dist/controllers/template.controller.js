...
const templateService_1 = require("../services/templates/templateService");
...
class TemplateController {
    ...
    async getAllCategories(req, res) {
        ...
        try {
            ...
            const categories = await templateService_1.templateService.getAllCategories();
    ...
    async getTemplatesByCategory(req, res) {
        ...
        try {
            ...
            const templates = await templateService_1.templateService.getTemplatesByCategory(id);
            return res.status(200).json({ templates });
        }
        catch (error) {
            logger_1.logger.error('Error fetching templates by category:', error);
            return res.status(500).json({ error: 'Internal server error' });
        }
    }
    /**
    ...
    async getTemplateById(req, res) {
        ...
        try {
            ...
            logger_1.logger.error('Error fetching template by ID:', error);
            return res.status(500).json({ error: 'Internal server error' });
        }
    }
    /**
    ...
    async createTemplate(req, res) {
        ...
        try {
            ...
            const newTemplate = await templateService_1.templateService.createTemplate({
                name,
                description,
                category,
                nodeType,
    ...
    async updateTemplate(req, res) {
        ...
        try {
            ...
            const updatedTemplate = await templateService_1.templateService.updateTemplate(id, {
                name,
                description,
                category,
                config
    ...
    async deleteTemplate(req, res) {
        ...
        try {
            ...
            const success = await templateService_1.templateService.deleteTemplate(id);
            if (!success) {
